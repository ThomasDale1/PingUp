    ...
    <div className='flex flex-col h-screen'>
      ...
      <div className='px-4'>
          <div className='flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5'>
            <input onChange={(e)=>setText(e.target.value)} value={text} className='flex-1 outline-none text-slate-700' type="text" onKeyDown={(e)=>e.key == 'Enter' && sendMessage()} placeholder='Type a message...'/>
            <label htmlFor="image">
              {
                image ? <img src={URL.createObjectURL(image)} className="rounded h-8" />
